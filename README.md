...
- 🔒 **Secure Architecture** — Building full-stack web applications with hardened authentication (signed HMAC session cookies, IDOR-safe file handling) and robust data protection.
...
|---|---|---|
| 📂 [**Vertex Canvas**](https://github.com/DevTechMike-Coder/KanbanTool) | Next.js-driven kanban workspace managing project timelines, tasks, and team contribution flows in real time. | `Next.js` `PostgreSQL` `Prisma` `Supabase` |
| 🛡️ [**VulnTrack Lite**](https://github.com/DevTechMike-Coder/VulnTrack-Lite) | Vulnerability monitoring dashboard with 3D motion graphs for visualizing threat intelligence. | `React` `Framer Motion` `Tailwind CSS` |
